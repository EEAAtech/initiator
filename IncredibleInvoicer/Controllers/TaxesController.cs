...
{
    public class TaxesController : EAController
    {
        ...
        public ActionResult Create([Bind(Include = "TaxID,Tax1")] Tax tax)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaxID,Tax1")] Tax tax)
        {
            if (ModelState.IsValid)
            {
